...
//       List<Token> tokens = [];
//       for (dynamic token in response.data['result'] as Iterable<dynamic>) {
...
//               'decimals': int.parse(token['decimals'] as String),
//               'name': Formatter.formatTokenName(token['name'] as String),
//               'symbol': token['symbol'],
//             }).copyWith(
//               timestamp: 0,
//             ),
