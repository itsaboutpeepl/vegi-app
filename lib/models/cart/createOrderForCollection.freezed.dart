...
class _$_CreateOrderForCollection extends _CreateOrderForCollection {
  ...
  @override
  String toString() {
    return 'CreateOrderForCollection(items: $items, total: $total, tipAmount: $tipAmount, marketingOptIn: $marketingOptIn, discountCode: $discountCode, vendor: $vendor, walletAddress: $walletAddress, address: $address, fulfilmentMethod: $fulfilmentMethod, fulfilmentSlotFrom: $fulfilmentSlotFrom, fulfilmentSlotTo: $fulfilmentSlotTo)';
  }
