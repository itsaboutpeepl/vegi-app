...
RestaurantItem restaurantItem1 = RestaurantItem(
...
RestaurantItem restaurantItem3 = RestaurantItem(
...
DeliveryAddresses demoAddress = DeliveryAddresses(
  internalID: 80085,
...
final RestaurantMenuItem bagel2 = RestaurantMenuItem(
  isFeatured: true,
  menuItemID: 'menuID2',
  restaurantID: 'DEMO',
...
final RestaurantMenuItem bagel3 = RestaurantMenuItem(
  isFeatured: true,
  menuItemID: 'menuID3',
  restaurantID: 'DEMO',
...
CartItem demoOrderItem1 = CartItem(
  internalID: 4324,
  menuItem: bagel3,
  totalItemPrice: 3242,
  itemQuantity: 3,
...
CartItem demoOrderItem2 = CartItem(
  internalID: 3414,
  menuItem: bagel1,
  totalItemPrice: 8922,
  itemQuantity: 5,
