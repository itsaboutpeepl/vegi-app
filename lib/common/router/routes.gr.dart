...
import '../../features/account/screens/profile.dart' as _i38;
...
class RootRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    CheckoutScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return const _i17.CheckoutScreen();
        }),
    ...
    ActionDetailsScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i19.ActionDetailsScreen(
              action: args.action,
              image: args.image,
    ...
    TopupExplained.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i21.TopupExplained(key: args.key);
        }),
    HelpScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i22.HelpScreen();
        }),
    ...
    ProfileScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i38.ProfileScreen(key: args.key);
        }),
    SocialScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i39.SocialScreen();
        })
  };
        ...
        _i1.RouteConfig(MainScreen.name, path: '/main-screen', guards: [
          ...
          _i1.RouteConfig(VeganHomeAltTab.name,
              ...
              children: [
                ...
                _i1.RouteConfig(CheckoutScreen.name,
                    path: 'checkout-screen', guards: [authGuard])
              ]),
...
class ToteScreen extends _i1.PageRouteInfo<ToteScreenArgs> {
  ToteScreen({_i2.Key? key, required _i40.UserCart userCart})
      : super(name,
            path: 'tote-screen',
...
class CheckoutScreen extends _i1.PageRouteInfo {
  const CheckoutScreen() : super(name, path: 'checkout-screen');
...
class SwapScreen extends _i1.PageRouteInfo<SwapScreenArgs> {
  SwapScreen({_i2.Key? key, _i45.Token? primaryToken})
      : super(name,
            path: '',
