...
import '../../features/guideHome/screens/guideHome.dart' as _i16;
import '../../features/guideNews/screens/newsScreen.dart' as _i17;
...
class RootRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    VeganHomeTab.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return const _i1.EmptyRouterPage();
        }),
    ...
    VeganHomeScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return const _i15.VeganHomeScreen();
        }),
    GuideHomeScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return const _i16.GuideHomeScreen();
        }),
    NewsHomeScreen.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i17.NewsScreen();
        }),
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(MainScreen.name, path: '/main-screen', guards: [
          ...
          _i1.RouteConfig(VeganHomeTab.name, path: 'veganHome', children: [
            _i1.RouteConfig(VeganHomeScreen.name, path: '', guards: [authGuard])
          ]),
...
class VeganHomeTab extends _i1.PageRouteInfo {
  const VeganHomeTab({List<_i1.PageRouteInfo>? children})
      : super(name, path: 'veganHome', initialChildren: children);
...
class VeganHomeScreen extends _i1.PageRouteInfo {
  const VeganHomeScreen() : super(name, path: '');
