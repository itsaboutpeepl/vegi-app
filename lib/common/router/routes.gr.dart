...
import 'package:contacts_service/contacts_service.dart' as _i44;
import 'package:flutter/material.dart' as _i40;

import '../../features/account/screens/account_screen.dart' as _i33;
import '../../features/account/screens/done_backup_screen.dart' as _i36;
import '../../features/account/screens/profile.dart' as _i17;
import '../../features/account/screens/protect_your_wallet.dart' as _i38;
import '../../features/account/screens/settings.dart' as _i37;
import '../../features/account/screens/show_mnemonic.dart' as _i34;
import '../../features/account/screens/social_screen.dart' as _i39;
import '../../features/account/screens/verify_mnemonic.dart' as _i35;
import '../../features/buy/screens/business.dart' as _i30;
import '../../features/buy/screens/buy.dart' as _i29;
import '../../features/contacts/screens/contacts_list.dart' as _i24;
import '../../features/contacts/screens/send_amount.dart' as _i25;
import '../../features/contacts/screens/send_review.dart' as _i26;
import '../../features/contacts/screens/send_success.dart' as _i27;
import '../../features/contacts/send_amount_arguments.dart' as _i45;
import '../../features/home/screens/action_details.dart' as _i21;
import '../../features/home/screens/home.dart' as _i20;
...
import '../../features/screens/help.dart' as _i23;
import '../../features/screens/inapp_webview_page.dart' as _i28;
...
import '../../features/swap/screens/review_swap.dart' as _i32;
import '../../features/swap/screens/swap.dart' as _i31;
import '../../features/topup/screens/topup.dart' as _i18;
import '../../features/topup/screens/topup_explained.dart' as _i22;
...
import '../../features/veganHome/screens/veganHomeAlternate.dart' as _i12;
import '../../features/veganHome/widgets/testPeeplPay.dart' as _i19;
import '../../models/actions/wallet_action.dart' as _i43;
import '../../models/community/business.dart' as _i46;
import '../../models/restaurant/menuItem.dart' as _i42;
import '../../models/swap/swap.dart' as _i48;
import '../../models/tokens/token.dart' as _i47;
import 'route_guards.dart' as _i41;
...
class RootRouter extends _i11.RootStackRouter {
  ...
  final Map<String, _i11.PageFactory> pagesMap = {
    ...
    VeganHomeScreenAlt.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i12.VeganHomeScreenAlternate());
    },
    ...
    TestPeeplPay.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i19.TestPeeplPay());
    },
    HomeScreen.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i20.HomeScreen());
    },
    ActionDetailsScreen.name: (routeData) {
      final args = routeData.argsAs<ActionDetailsScreenArgs>();
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i21.ActionDetailsScreen(
              action: args.action,
              image: args.image,
    ...
    TopupExplained.name: (routeData) {
      ...
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i22.TopupExplained(key: args.key));
    },
    HelpScreen.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i23.HelpScreen());
    },
    ...
    SwapScreen.name: (routeData) {
      ...
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData,
          child:
              _i31.SwapScreen(key: args.key, primaryToken: args.primaryToken));
    },
    ReviewSwapScreen.name: (routeData) {
      final args = routeData.argsAs<ReviewSwapScreenArgs>();
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i32.ReviewSwapScreen(
    ...
    AccountScreen.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i33.AccountScreen());
    },
    ShowMnemonic.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i34.ShowMnemonic());
    },
    VerifyMnemonic.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i35.VerifyMnemonic());
    },
    DoneBackup.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i36.DoneBackup());
    },
    SettingsScreen.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i37.SettingsScreen());
    },
    ProtectYourWallet.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i38.ProtectYourWallet());
    },
    SocialScreen.name: (routeData) {
      return _i11.MaterialPageX<dynamic>(
          routeData: routeData, child: _i39.SocialScreen());
    }
  };
  ...
  List<_i11.RouteConfig> get routes => [
        ...
        _i11.RouteConfig(MainScreen.name, path: '/main-screen', guards: [
          ...
          _i11.RouteConfig(VeganHomeAltTab.name,
              path: 'veganHomeAlt',
              parent: MainScreen.name,
              children: [
                _i11.RouteConfig(VeganHomeScreenAlt.name,
                    path: '',
                    parent: VeganHomeAltTab.name,
                    guards: [authGuard]),
                _i11.RouteConfig(RestaurantMenuScreen.name,
                    path: 'restaurant-menu-screen',
                    parent: VeganHomeAltTab.name,
                    guards: [authGuard]),
                _i11.RouteConfig(ToteScreen.name,
                    path: 'tote-screen',
                    parent: VeganHomeAltTab.name,
                    guards: [authGuard]),
                _i11.RouteConfig(CheckoutScreen.name,
                ...
                _i11.RouteConfig(TopUpScreen.name,
                    ...
                    parent: VeganHomeAltTab.name,
                    guards: [authGuard]),
                _i11.RouteConfig(TestPeeplPay.name,
                    path: 'test-peepl-pay',
                    parent: VeganHomeAltTab.name,
                    guards: [authGuard])
              ]),
...
class SplashScreen extends _i11.PageRouteInfo<SplashScreenArgs> {
  SplashScreen({_i40.Key? key, void Function(bool)? onLoginResult})
...
class MainScreen extends _i11.PageRouteInfo<MainScreenArgs> {
  MainScreen({_i40.Key? key, List<_i11.PageRouteInfo>? children})
...
class VeganHomeAltTab extends _i11.PageRouteInfo<void> {
  const VeganHomeAltTab({List<_i11.PageRouteInfo>? children})
...
/// generated route for
/// [_i12.VeganHomeScreenAlternate]
class VeganHomeScreenAlt extends _i11.PageRouteInfo<void> {
...
class RestaurantMenuScreen
    extends _i11.PageRouteInfo<RestaurantMenuScreenArgs> {
  RestaurantMenuScreen({_i40.Key? key, required List<_i42.MenuItem> menuList})
...
class RestaurantMenuScreenArgs {
  ...
  final List<_i42.MenuItem> menuList;
...
/// generated route for
/// [_i14.ToteScreen]
class ToteScreen extends _i11.PageRouteInfo<void> {
...
/// generated route for
/// [_i15.CheckoutScreen]
class CheckoutScreen extends _i11.PageRouteInfo<void> {
...
class OrderConfirmedScreen extends _i11.PageRouteInfo<void> {
...
/// generated route for
/// [_i19.TestPeeplPay]
class TestPeeplPay extends _i11.PageRouteInfo<void> {
  const TestPeeplPay() : super(TestPeeplPay.name, path: 'test-peepl-pay');

  static const String name = 'TestPeeplPay';
}
...
/// generated route for
/// [_i21.ActionDetailsScreen]
class ActionDetailsScreen extends _i11.PageRouteInfo<ActionDetailsScreenArgs> {
  ActionDetailsScreen(
      {required _i43.WalletAction action,
      _i40.ImageProvider<Object>? image,
      required String displayName,
      String? accountAddress,
      required String symbol,
      _i44.Contact? contact})
...
class ActionDetailsScreenArgs {
  ...
  final _i43.WalletAction action;

  final _i40.ImageProvider<Object>? image;
...
class ContactsList extends _i11.PageRouteInfo<ContactsListArgs> {
  ContactsList({_i45.SendFlowArguments? pageArgs})
...
class ContactsListArgs {
  ...
  final _i45.SendFlowArguments? pageArgs;
...
/// generated route for
/// [_i25.SendAmountScreen]
class SendAmountScreen extends _i11.PageRouteInfo<SendAmountScreenArgs> {
  SendAmountScreen({required _i45.SendFlowArguments pageArgs})
...
/// generated route for
/// [_i26.SendReviewScreen]
class SendReviewScreen extends _i11.PageRouteInfo<SendReviewScreenArgs> {
  SendReviewScreen({required _i45.SendFlowArguments pageArgs})
...
/// generated route for
/// [_i27.SendSuccessScreen]
class SendSuccessScreen extends _i11.PageRouteInfo<SendSuccessScreenArgs> {
  SendSuccessScreen({required _i45.SendFlowArguments pageArgs})
...
class BusinessScreen extends _i11.PageRouteInfo<BusinessScreenArgs> {
  BusinessScreen({required _i46.Business business, required _i47.Token token})
...
class BusinessScreenArgs {
  ...
  final _i46.Business business;

  final _i47.Token token;
...
class SwapScreen extends _i11.PageRouteInfo<SwapScreenArgs> {
  SwapScreen({_i40.Key? key, _i47.Token? primaryToken})
...
/// generated route for
/// [_i32.ReviewSwapScreen]
class ReviewSwapScreen extends _i11.PageRouteInfo<ReviewSwapScreenArgs> {
  ReviewSwapScreen(
      {required _i48.TradeInfo tradeInfo,
      required _i48.TradeInfo rateInfo,
      required _i48.SwapRequestBody swapRequestBody})
...
class ReviewSwapScreenArgs {
  ...
  final _i48.TradeInfo tradeInfo;

  final _i48.TradeInfo rateInfo;

  final _i48.SwapRequestBody swapRequestBody;
